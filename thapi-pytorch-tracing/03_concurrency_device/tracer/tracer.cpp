// Step 3 tracer — one .so, four granularity aspects, selected at load time by
// environment variables so a SINGLE build covers every experiment:
//
...
//
// The trace itself always carries scope + depth on every event (aspect 2 and 4
