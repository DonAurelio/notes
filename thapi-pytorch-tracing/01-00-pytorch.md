...
**Figure 2.** Forward (predit) and Backward (learn)

![Perceptron](./img/forward_backward.png) 

**Animation 1.** Forward (predit) and Backward (learn)

![Perceptron](./img/forward_backward.gif) 
